...
<!DOCTYPE html>
    ...
    <br></br>
    <div class="container">
    <h1 style = "color : ghostwhite;">Manufacturing Department Dashboard</h1>
    <a class = "btn btn-danger" href="logout.php">Logout</a>
    <br>
    <br><p style = "color : ghostwhite;">Filed Warranty Claims for Reparable Products:</p>               
    ...
    <div 
        ...
        LEFT JOIN customer ON warranty.customerID = customer.customerID LEFT JOIN department ON warranty.departmentID = department.departmentID WHERE warranty.status = 1 AND warranty.departmentID = 2"; 
        ...
        <tr>
            ...
            <td><?php echo $date;?></td>
            <td align = "center"><a class="btn btn-success" href="manufacturing-dashboard.php?del=<?php echo $warrantyTrackingNumber;?>"><completed>
		    </a></td>
        </tr>
        </tr>
        <?php }?>
